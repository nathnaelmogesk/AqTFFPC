    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-blue-50 to-emerald-50 p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold text-gray-900">FeedFortune</h1>
          <p className="text-gray-600">AgriTech Marketplace for East Africa</p>
        </div>
        ...
        <div className="text-center text-sm text-gray-500">
          <p>© 2024 FeedFortune. Supporting East African Agriculture.</p>
          <p className="mt-1">🇷🇼 Made for Rwanda & EAC Region</p>
        </div>
      </div>
    </div>
  );
